...
#             print(f"  VM {vm.name} already running")
#             return
...
#                 print(f"  Kernel file not found (simulating boot)")
#         else:
#             print("  Step 5: No kernel specified, VM idle")
        
        # Step 6: Start VM execution
#         print("  Step 6: Starting VM execution...")
...
#         if vm.state != VMState.RUNNING:
#             print(f"  VM {vm.name} not running")
#             return
...
#         except FileNotFoundError:
#             print(f"     Kernel not found (will simulate boot)")
