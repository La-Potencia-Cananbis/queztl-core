...
echo ""
echo "🧪 Test commands:"
echo "  ssh xava@$BEAST_IP 'cd ~/queztl-core && source venv/bin/activate && python backend/queztl_agents.py --demo'"
echo "  ssh xava@$SLOTH_IP 'cd ~/queztl-core && source venv/bin/activate && python backend/queztl_agents.py --demo'"
